...
// 데이터 : name, age, gender, birth(String=>13장 수업 후에 Date형) 
// 생성자 : new PersonInfo("홍길동", 22, '남', "2001-12-01"), new PersonInfo("홍길동", 22, '남') - 생성자 오버로딩
// 메소드 : print()
public class PersonInfo {
	...
	public void print() { // 객체 정보 출력
		...
		System.out.println("생년월일 :" +(birth==null?"-":birth));
	}
